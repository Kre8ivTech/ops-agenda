---
name: orchestrate
description: Manage development phases and quality gates. Use for starting new projects, advancing phases, and navigating the development lifecycle.
---
...
3. Update `Codex-activeContext.md` with:
   - Current Phase: -1
...
1. Read current phase from `Codex-activeContext.md`
...
4. Update `Codex-activeContext.md`
...
```
Check Codex-activeContext.md for:
...
On every phase transition, update `Codex-activeContext.md`:
...
- If `Codex-activeContext.md` doesn't exist, create it with Phase -1
