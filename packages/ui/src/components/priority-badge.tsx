/**
 * The priority taxonomy, declared structurally here so the design system stays
 * free of a schema dependency. `packages/web` derives the same union from its
 * Zod `prioritySchema`, so the two remain assignable in both directions.
 */
